...
que permite a un objeto notificar a otros objetos sobre
cambios en su estado."""

"""El patrón Observer proporciona una forma de suscribirse
y cancelar la subscripción a estos eventos para cualquier objeto
que implementa una interfaz suscriptora."""


class Subject(ABC):
    """The Subject interface declares a set of methods for
